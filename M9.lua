local Data = {
	...
	Model = game.ReplicatedStorage.Assets.Viewmodels:WaitForChild('M9'),
	...
	Animations = {
		Idle = nil,
		Fire = script:WaitForChild('Anim_Fire'),
		Reload = script:WaitForChild('Anim_Reload'),
		Equip = nil,
		Sprint = nil,
		Aim = script:WaitForChild('Anim_Aim'),
	},
...
local M9 = WeaponInstance.new(Data)
