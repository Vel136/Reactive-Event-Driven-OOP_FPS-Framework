...
export type CanPierceFunction = TypeDefs.CanPierceFunction
export type GenericTable = TypeDefs.GenericTable
export type Caster = TypeDefs.Caster
export type FastCastBehavior = TypeDefs.FastCastBehavior
export type CastTrajectory = TypeDefs.CastTrajectory
export type CastStateInfo = TypeDefs.CastStateInfo
export type CastRayInfo = TypeDefs.CastRayInfo
