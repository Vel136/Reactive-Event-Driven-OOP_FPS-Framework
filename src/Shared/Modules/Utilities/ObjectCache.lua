...
function Cache:ReturnAll()
	-- Collect all parts that are in use (those with nil value in _Objects)
	for Part, IsFree in pairs(self._Objects) do
		if not IsFree then
